...
const JobListing = () => {
  ...
  const [selectedCatogories, setSelectedCatogories] = useState([])
  ...
  useEffect(() => {
      const matchesCategory = job => selectedCatogories.length === 0 || selectedCatogories.includes(job.category)
  ...
  },[jobs, selectedCatogories, selectedLocations, searchFilter])
      ...
      <div className="w-full lg:w-1/4 bg-white px-4">
        ...
        {isSearched &&
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              <h3 className="font-medium text-lg mb-4">Currenet Search</h3>
              ...
              JobCategories.map((category, index) => (
                  ...
                  <input 
                    ...
                    type="checkbox" 
                     ...
                     checked = {selectedCatogories.includes(category)}
                     />
